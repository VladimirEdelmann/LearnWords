 ...
 */
 exports.seed = async function(knex) {
  ...
  await knex('native_words').insert([
    {id: 1, fw_id: 1, lang_part: 'noun', native_word: 'грізний', examples: ["some", "more", "examples"],
  explanation: "this is explanation", association: 'powerful man', tags: ['some', 'tags']},
    {id: 2, fw_id: 2, lang_part: 'verb', native_word: 'сильний', examples: ["some", "more", "examples"],
    explanation: "this is explanation", association: 'strong man', tags: ['some', 'tags']},
    {id: 3, fw_id: 2, lang_part: 'noun', native_word: 'могутній', examples: ["some", "more", "examples"],
    explanation: "this is explanation", association: 'powerful man', tags: ['some', 'tags']}
  ]);
};
